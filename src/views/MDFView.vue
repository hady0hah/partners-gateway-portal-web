...
<!--                  </date-picker>-->
              ...
              <v-row v-if="section.name === 'section2'">
                <v-col class="col-12 col-md-5">
                  <product-list-form :disabled="formConfig.disabled" :first_field_name="'resouce_allocation'" :second_field_name="'amount'" :fields="section.fields['resourceAllocation']['fields']" :form_name="formConfig.form_name" v-bind:value="getFieldValue(section.fields['resourceAllocation'])" v-on:input="onInput(section, $event)" v-bind="section.fields['resourceAllocation']"></product-list-form>
                </v-col>
                <v-col class="col-12 col-md-5">
